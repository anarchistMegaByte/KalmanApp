...
public class KalmanFilterEquation implements KalmanFilter{
    ...
    public void configure(DMatrixRMaj F, DMatrixRMaj Q, DMatrixRMaj H) {
        ...
        this.F = new DMatrixRMaj(dimenX, dimenX);
        this.F.set(F);
    ...
    @Override
    public void setState(DMatrixRMaj x, DMatrixRMaj P, DMatrixRMaj F) {
        this.x.set(x);
        this.P.set(P);
        this.F.set(F);
    }
    ...
    @Override
    public void predict(DMatrixRMaj F_k) {
        eq.alias(F_k,"F");
    ...
    public void update(DMatrixRMaj z, DMatrixRMaj R) {
        ...
        updateY.perform();
        Log.e("Dimension P",this.P.numRows + "-" + this.P.numCols);
        Log.e("Dimension R",R.numRows + "-" + R.numCols);
        updateK.perform();
        updateX.perform();
        updateP.perform();
    }
